...
To set up configuration, invoke the test-setup skill which will guide you through an interactive setup flow.
...
Run '${python_exe} ${setup_script} --describe --data-dir ${plugin_data}' to see field descriptions."
        ...
        local user_msg="test-plugin configuration is incomplete. Say 'setup test-plugin' to configure."
