...
If you are reading this, `/should-be-invocable` resolved to this skill body and the plugin slash-menu registration is working as documented.

Reply with the literal string: `repro: slash menu reached the skill body`.
