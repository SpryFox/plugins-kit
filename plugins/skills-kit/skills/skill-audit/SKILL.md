...
description: Use when auditing a SKILL.md against the framework's type contract and the content-allocation rules. Do NOT use for CLAUDE.md (use /claude-md-audit).
