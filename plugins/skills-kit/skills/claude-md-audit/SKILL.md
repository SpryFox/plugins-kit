...
description: Use when the user invokes /claude-md-audit to audit a CLAUDE.md against the cohesion-principles framework. Do NOT use for SKILL.md (use /skill-audit).
